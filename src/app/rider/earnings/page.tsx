...
import { BarChart, DollarSign, ArrowUpRight, ArrowDownRight, Download } from 'lucide-react';

export default function RiderEarnings() {
    const EARNINGS_HISTORY = [
        { date: 'Today, Mar 9', trips: 14, earnings: '₦14,200', status: 'Pending Payout' },
        { date: 'Yesterday, Mar 8', trips: 22, earnings: '₦21,450', status: 'Paid' },
        { date: 'Sat, Mar 7', trips: 26, earnings: '₦28,900', status: 'Paid' },
        { date: 'Fri, Mar 6', trips: 18, earnings: '₦17,300', status: 'Paid' },
        { date: 'Thu, Mar 5', trips: 20, earnings: '₦20,100', status: 'Paid' },
    ];
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    ...
                    <p style={{ margin: '8px 0 0', color: 'var(--text-secondary)' }}>Track your daily income and payouts.</p>
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
                <Card style={{ padding: '24px' }}>
                    ...
                    <h2 style={{ margin: '0 0 8px 0', fontSize: '32px' }}>₦14,200</h2>
                ...
                <Card style={{ padding: '24px' }}>
                    ...
                    <h2 style={{ margin: '0 0 8px 0', fontSize: '32px' }}>₦84,500</h2>
                ...
                <Card style={{ padding: '24px', gridColumn: 'span 2', backgroundColor: 'var(--brand-black)', color: 'white' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                        <div>
                            ...
                            <span style={{ fontSize: '36px', fontWeight: 700 }}>₦84,500</span>
                        </div>
                        <div style={{ textAlign: 'right' }}>
                            <span style={{ display: 'block', color: '#888', marginBottom: '4px' }}>Date</span>
                            <span style={{ fontSize: '20px', fontWeight: 600 }}>Monday, Mar 16</span>
                        </div>
                    </div>
                </Card>
            </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <thead>
                        <tr style={{ backgroundColor: '#F9FAFB', borderBottom: '1px solid var(--border)' }}>
                            ...
                            <th style={{ padding: '16px 20px', color: 'var(--text-secondary)', fontWeight: 600, fontSize: '14px' }}>Completed Trips</th>
                            <th style={{ padding: '16px 20px', color: 'var(--text-secondary)', fontWeight: 600, fontSize: '14px' }}>Earnings</th>
